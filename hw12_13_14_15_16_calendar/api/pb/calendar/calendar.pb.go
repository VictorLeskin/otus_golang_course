...
type ListEventsInIntervalRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *ListEventsInIntervalRequest) Reset() {
	*x = ListEventsInIntervalRequest{}
	mi := &file_calendar_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListEventsInIntervalRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListEventsInIntervalRequest) ProtoMessage() {}

func (x *ListEventsInIntervalRequest) ProtoReflect() protoreflect.Message {
	mi := &file_calendar_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListEventsInIntervalRequest.ProtoReflect.Descriptor instead.
func (*ListEventsInIntervalRequest) Descriptor() ([]byte, []int) {
	return file_calendar_proto_rawDescGZIP(), []int{6}
}

func (x *ListEventsInIntervalRequest) GetFrom() *timestamppb.Timestamp {
	if x != nil {
		return x.From
	}
	return nil
...
func (x *ListEventsInIntervalRequest) GetTo() *timestamppb.Timestamp {
	if x != nil {
		return x.To
	}
	return nil
...
const file_calendar_proto_rawDesc = "" +
	...
	"\x1bListEventsInIntervalRequest\x12.\n" +
	"\x04from\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\x04from\x12*\n" +
	"\x02to\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\x02to\"a\n" +
	...
	"\rerror_message\x18\x02 \x01(\tR\ferrorMessage2\xde\x03\n" +
	...
	"\n" +
	"ListEvents\x12\x1b.calendar.ListEventsRequest\x1a\x1c.calendar.ListEventsResponse\x12[\n" +
	"\x14ListEventsInInterval\x12%.calendar.ListEventsInIntervalRequest\x1a\x1c.calendar.ListEventsResponseB\x15Z\x13./calendar;calendarb\x06proto3"
...
var file_calendar_proto_goTypes = []any{
	...
	(*ListEventsInIntervalRequest)(nil), // 6: calendar.ListEventsInIntervalRequest
	(*CreateEventResponse)(nil),         // 7: calendar.CreateEventResponse
	(*UpdateEventResponse)(nil),         // 8: calendar.UpdateEventResponse
	(*DeleteEventResponse)(nil),         // 9: calendar.DeleteEventResponse
	(*GetEventResponse)(nil),            // 10: calendar.GetEventResponse
	(*ListEventsResponse)(nil),          // 11: calendar.ListEventsResponse
	(*timestamppb.Timestamp)(nil),       // 12: google.protobuf.Timestamp
}
var file_calendar_proto_depIdxs = []int32{
	12, // 0: calendar.Event.start_time:type_name -> google.protobuf.Timestamp
	12, // 1: calendar.Event.end_time:type_name -> google.protobuf.Timestamp
	...
	12, // 4: calendar.ListEventsInIntervalRequest.from:type_name -> google.protobuf.Timestamp
	12, // 5: calendar.ListEventsInIntervalRequest.to:type_name -> google.protobuf.Timestamp
	0,  // 6: calendar.CreateEventResponse.event:type_name -> calendar.Event
	0,  // 7: calendar.UpdateEventResponse.event:type_name -> calendar.Event
	0,  // 8: calendar.GetEventResponse.event:type_name -> calendar.Event
	0,  // 9: calendar.ListEventsResponse.events:type_name -> calendar.Event
	1,  // 10: calendar.CalendarService.CreateEvent:input_type -> calendar.CreateEventRequest
	...
	4,  // 13: calendar.CalendarService.GetEvent:input_type -> calendar.GetEventRequest
	5,  // 14: calendar.CalendarService.ListEvents:input_type -> calendar.ListEventsRequest
	6,  // 15: calendar.CalendarService.ListEventsInInterval:input_type -> calendar.ListEventsInIntervalRequest
	7,  // 16: calendar.CalendarService.CreateEvent:output_type -> calendar.CreateEventResponse
	8,  // 17: calendar.CalendarService.UpdateEvent:output_type -> calendar.UpdateEventResponse
	9,  // 18: calendar.CalendarService.DeleteEvent:output_type -> calendar.DeleteEventResponse
	10, // 19: calendar.CalendarService.GetEvent:output_type -> calendar.GetEventResponse
	11, // 20: calendar.CalendarService.ListEvents:output_type -> calendar.ListEventsResponse
	11, // 21: calendar.CalendarService.ListEventsInInterval:output_type -> calendar.ListEventsResponse
