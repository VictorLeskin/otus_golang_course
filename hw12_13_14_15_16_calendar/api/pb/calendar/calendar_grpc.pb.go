...
const (
	...
	CalendarService_ListEventsInInterval_FullMethodName = "/calendar.CalendarService/ListEventsInInterval"
)
...
//
// service ( duplicte Storage interface )
type CalendarServiceClient interface {
	...
	ListEventsInInterval(ctx context.Context, in *ListEventsInIntervalRequest, opts ...grpc.CallOption) (*ListEventsResponse, error)
}
...
func (c *calendarServiceClient) ListEventsInInterval(ctx context.Context, in *ListEventsInIntervalRequest, opts ...grpc.CallOption) (*ListEventsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListEventsResponse)
	err := c.cc.Invoke(ctx, CalendarService_ListEventsInInterval_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CalendarServiceServer interface {
	...
	ListEventsInInterval(context.Context, *ListEventsInIntervalRequest) (*ListEventsResponse, error)
...
func (UnimplementedCalendarServiceServer) ListEventsInInterval(context.Context, *ListEventsInIntervalRequest) (*ListEventsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListEventsInInterval not implemented")
}
...
func _CalendarService_ListEventsInInterval_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListEventsInIntervalRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CalendarServiceServer).ListEventsInInterval(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CalendarService_ListEventsInInterval_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalendarServiceServer).ListEventsInInterval(ctx, req.(*ListEventsInIntervalRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CalendarService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListEventsInInterval",
			Handler:    _CalendarService_ListEventsInInterval_Handler,
		},
	},
